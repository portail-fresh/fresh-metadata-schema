...
- `samples/` — Synthetic sample XML files following the schema specifications
...
[FReSH Schema Documentation]([FReSH Schema Documentation](https://portail-fresh.github.io/fresh-metadata-schema/fresh-schema.html)  
